...
DCID=24
VPSPLANID=vc2-2c-4gb # Plan: Cheapest 5$ per month
OSID=387 # OS Details: Ubuntu 18.04 x64
SCRIPTID=617519 # Created WebUI, sets up all the requirements for BL2 VPN Node for LAN
SSHKEYID='5d8d8282e63f7,5dbbb33d01198,627d9fbed28c0' # SSH key to automatically add
NODENAME='PZSteamDediServerNode'
...
# done
cat $NEW_SERVER_IP > PZ_SERVER_IP
